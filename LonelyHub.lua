...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Lonely Hub Premium Scripts") then
			makefolder("Lonely Hub Premium Scripts")
		end
		if not isfolder("Lonely Hub Premium Scripts/Blox Fruits/") then
			makefolder("Lonely Hub Premium Scripts/Blox Fruits/")
		end
		if not isfile("Lonely Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("Lonely Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("Lonely Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("Lonely Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			writefile("Lonely Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		end
	else
		return warn("Status : Undetected Executor")
	end
...
if QuestC.Visible == true then
						...
						local Tab1 = Main.create("LongHip2012")
						
						local Tab2 = Main.create("LongHip2012")
						
						local Tab3 = Main.create("LongHip2012")
						
						local Tab4 = Main.create("LongHip2012")
						
						local Tab5 = Main.create("LongHip2012")
