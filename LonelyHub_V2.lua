...
_G.ThongBaoChoose = "LonelyHub Free Script"
...
-- LonelyHub rất ngon và free script:)))
...
--------------------------------------------------------------------------------------------------------
local Library = Update:Window("Lonely Hub","BLOX FRUIT",Enum.KeyCode.RightControl);
--------------------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------------------
TienTiny:AddSeperator("LONELY HUB")
...
TienTiny:AddLabel("Owner: Nguyen Hoang Long(Lonely Hub)")
